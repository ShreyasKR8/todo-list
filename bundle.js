...
function addDefaultProject(projectName) {
    ...
    projectDiv.addEventListener("click", () => {
        const loadedProject = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].loadProjectFromLocalStorage(projectName);
        if(!loadedProject) {
            return;
        }
...
function createDefaultProject() {
    ...
    const todoItem1 = new _components_todo__WEBPACK_IMPORTED_MODULE_2__["default"]("Go Running", "Run!", "29-08-2024", "High");
